      ...
      <section className="bg-white p-4 rounded-xl shadow-sm space-y-3">
        ...
        {!!laudos?.length && (
          <table className="w-full text-sm">
            <thead><tr className="text-left border-b"><th className="p-2">Número</th><th>Revisão</th><th>Status</th></tr></thead>
            <tbody>{laudos.map(l => (
        ...
        <p className="text-xs text-slate-500">
          Aprovação, emissão com numeração oficial e impressão do laudo de laboratório chegam na próxima fase.
        </p>
      </section>
